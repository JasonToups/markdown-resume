...
| **Production**:   | Software Releases • Technical Documentation • Figma • UI/UX Design • Affinity Designer • OBS • Adobe Audition • Audacity • Audio Engineering • Podcast Production • Keynote • Public Speaking |
...
Created a [Podcast](https://web.archive.org/web/20180322224849/http://gaymebar.com/) with Jeremiah Bratton, where we discussed our love of video games through a queer lens, and created a community where queer game creators, and critics could finally have a platform. There were few online discussions at the time about how the LGBTQIA+ community engages differently with games, so we created a podcast to explore our unique gaming perspectives.

- **Co-Hosted**, **Produced**, **Recorded** and **Edited** over _300_ Podcast episodes, and published them on Apple Podcasts & Stitcher.
- **Interviewed & Sourced** various guests such as _Rebecca Ann Heineman_ (Legendary Game Developer), _Edmund McMillen_ and _Tommy Refenes_ (Meatboy), _Samantha Allen_ (Author).
- **Spoke Publicly** at _MIT Gayme Jam_ (2012) _Penny Arcade Convention_ (PAX Prime 2012 & PAX Prime 2013), _GaymerX_ - Podcast X Zone Panel (2015).
- **Managed Social Media** on various platforms including Twitter (@GaymeBar) and our Facebook Group
